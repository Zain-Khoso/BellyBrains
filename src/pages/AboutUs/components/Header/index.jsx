  ...
  return (
    <StyledHeader>
      ...
      >
        ...
        <Illustration
          scale={
            width >= Number(theme.Breakpoints.tablet.slice(0, -2)) ? 20 : 40
          }
          light={AboutUsLight}
          dark={AboutUsDark}
        ...
        <IntroText>
          A culinary haven where passion meets plate. Established on July 9th,
          1969, in Sukkur, we have been crafting extraordinary dining
          experiences for over five decades. Join us in savoring the art of
          flavors and the joy of timeless moments. Your journey into exceptional
          food and coffee begins here.
        </IntroText>
      </PageIntro>
